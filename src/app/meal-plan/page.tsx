...
export default function MealPlanPage() {
  ...
  return (
    ...
    <div className="max-w-[1152px] mx-auto px-6 pb-16">
      ...
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-6 gap-3">
        <h1 className="text-3xl font-extrabold text-navy leading-tight">My meal plan</h1>
        <div className="flex items-center gap-2">
          <button
            onClick={emailList}
            className="flex items-center gap-2 border border-gray-300 text-navy font-semibold px-3 sm:px-4 py-2 rounded-xl hover:border-gray-400 transition-colors text-sm bg-white whitespace-nowrap"
          >
